...
export default function Header() {
  return (
    <>
      <div className="header w-[70vw] h-[15vh] text-sm">
        {/* Top of header (links) */}
        ...
        <div className="header-bottom w-[100%] h-[60%] flex items-center">
          ...
          >
            ...
            <Menu.Dropdown>
              <Menu.Item>
                <Link href="/browse/apparel" className="text-sm">Apparel</Link>
              </Menu.Item>
              <Menu.Item>
                <Link href="/browse/electronics" className="text-sm">Electronics</Link>
              </Menu.Item>
              <Menu.Item>
                <Link href="/browse/books" className="text-sm">Books</Link>
              </Menu.Item>
              <Menu.Item>
                <Link href="/browse/collectibles" className="text-sm">Collectibles</Link>
              </Menu.Item>
            </Menu.Dropdown>
          </Menu>
          <TextInput
            ...
            size="md"
            radius={"xl"}
            className="flex-7 mr-1 ml-1 border-2 rounded-full border-gray-400"
          />

          <Button
            size="md"
            radius={"xl"}
            className="flex-1 ml-3 mr-20 bg-green-900! hover:bg-green-700!"
          >
            Search
          </Button>
        </div>
